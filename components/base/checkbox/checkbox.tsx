...
export const CheckboxBase = ({ className, isSelected, isDisabled, isIndeterminate, size = "sm", isFocusVisible = false }: CheckboxBaseProps) => {
    return (
        <div
            className={cx(
                "flex size-4 shrink-0 cursor-pointer appearance-none items-center justify-center rounded bg-background ring-1 ring-border",
                size === "md" && "size-5 rounded-md",
                (isSelected || isIndeterminate) && "bg-primary ring-primary",
                isDisabled && "cursor-not-allowed bg-muted ring-muted-foreground/20",
        ...
        >
            <svg
                ...
                fill="none"
                className={cx(
                    "pointer-events-none absolute h-3 w-2.5 text-primary-foreground opacity-0 transition-inherit-all",
                    size === "md" && "size-3.5",
            ...
            <svg
                ...
                fill="none"
                className={cx(
                    "pointer-events-none absolute size-3 text-primary-foreground opacity-0 transition-inherit-all",
                    size === "md" && "size-3.5",
