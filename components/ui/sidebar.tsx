  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:mt-2 md:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:rounded-tl-2xl md:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:border-border/40",
