  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:mt-2 md:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:rounded-tl-2xl md:peer-data-[variant=floating]:m-2 md:peer-data-[variant=floating]:rounded-2xl md:peer-data-[variant=floating]:border md:peer-data-[variant=floating]:border-sidebar-border md:peer-data-[variant=floating]:shadow-sm",
